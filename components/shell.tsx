    ...
    <div className={cn("h-full", className)} {...props}>
      <div className="flex h-full min-h-[100vh] flex-row">
        ...
        <div className="grow pb-2 pr-2 pt-2">
          <div className="h-full bg-background bg-gradient-to-b from-amber-300/10 to-white bg-clip-border shadow-sm dark:from-orange-600/10 dark:to-black md:dark:border lg:rounded-lg"></div>
          {children}
        </div>
      </div>
    </div>
