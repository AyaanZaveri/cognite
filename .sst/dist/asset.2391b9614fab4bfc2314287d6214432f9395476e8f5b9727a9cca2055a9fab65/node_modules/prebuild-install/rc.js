...
module.exports = function (pkg) {
  ...
  const rc = require("rc")(
    "prebuild-install",
    {
      ...
      buildFromSource:
        buildFromSource === pkg.name || buildFromSource === "true",
      path: ".",
      proxy: env.npm_config_proxy || env.http_proxy || env.HTTP_PROXY,
      "https-proxy":
        env.npm_config_https_proxy || env.https_proxy || env.HTTPS_PROXY,
  ...
  rc.libc =
    rc.platform !== "linux" || rc.libc === detectLibc.GLIBC ? "" : rc.libc;
