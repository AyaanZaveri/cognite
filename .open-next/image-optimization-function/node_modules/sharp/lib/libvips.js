...
const minimumLibvipsVersionLabelled =
  env.npm_package_config_libvips /* istanbul ignore next */ || config.libvips;
...
const integrity = function (platformAndArch) {
  return (
    env[`npm_package_config_integrity_${platformAndArch.replace("-", "_")}`] ||
    config.integrity[platformAndArch]
  );
};
