...
const {
  ...
  defineDmmfProperty,
  Public,
} = require('@prisma/client/runtime/data-proxy')
...
exports.Prisma.CogScalarFieldEnum = {
  id: 'id',
  userId: 'userId',
  name: 'name',
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/ayaanzaveri/Code/cognition/node_modules/.pnpm/@prisma+client@5.1.1_prisma@5.0.0/node_modules/@prisma/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "node_modules/.pnpm/@prisma+client@5.1.1_prisma@5.0.0/node_modules/.prisma/client",
    ".pnpm/@prisma+client@5.1.1_prisma@5.0.0/node_modules/.prisma/client",
  ]
...
const { warnEnvConflicts } = require('@prisma/client/runtime/data-proxy')
