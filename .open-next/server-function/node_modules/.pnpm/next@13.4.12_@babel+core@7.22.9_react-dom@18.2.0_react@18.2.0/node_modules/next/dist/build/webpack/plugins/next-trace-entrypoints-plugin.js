        ...
        await span.traceChild("create-trace-assets").traceAsyncFn(async ()=>{
            ...
            for (const [entrypoint, entryFiles] of entryFilesMap){
                ...
                if (entrypoint.name.startsWith("app/")) {
                    ...
                    const clientManifestsForPage = entrypoint.name.endsWith("/page") || entrypoint.name === "/not-found" || entrypoint.name === "/_not-found" ? _path.default.join(outputPath, "..", entrypoint.name.replace(/%5F/g, "_") + "_" + _constants.CLIENT_REFERENCE_MANIFEST + ".js") : null;
