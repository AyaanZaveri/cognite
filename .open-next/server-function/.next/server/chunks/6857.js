 ...
 */ const useStateWithDeps = (state)=>{
    const rerender = (0,react_.useState)({})[1];
    const unmountedRef = (0,react_.useRef)(false);
    const stateRef = (0,react_.useRef)(state);
    // If a state property (data, error, or isValidating) is accessed by the render
    // function, we mark the property as a dependency so if it is updated again
    // in the future, we trigger a rerender.
    // This is also known as dependency-tracking.
    const stateDependenciesRef = (0,react_.useRef)({
        data: false,
        error: false,
        isValidating: false
    });
   ...
   * })
   * ```
   */ const setState = (0,react_.useCallback)((payload)=>{
        ...
        if (shouldRerender && !unmountedRef.current) {
            if (IS_REACT_LEGACY) {
                ...
                react_.startTransition(()=>rerender({}));
            }
        }
    }, [
        rerender
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/swr@2.2.0_react@18.2.0/node_modules/swr/mutation/dist/index.mjs
...
const mutation = ()=>{
    return (key, fetcher, config = {})=>{
        ...
        const ditchMutationsUntilRef = (0,react_.useRef)(0);
        ...
        const currentState = stateRef.current;
        const trigger = (0,react_.useCallback)(async (arg, opts)=>{
            const [serializedKey, resolvedKey] = dist_serialize(keyRef.current);
        ...
        []);
        const reset = (0,react_.useCallback)(()=>{
...
;// CONCATENATED MODULE: ./node_modules/.pnpm/ai@2.1.26_react@18.2.0_solid-js@1.7.8_svelte@4.1.1_vue@3.3.4/node_modules/ai/react/dist/index.mjs
'use client'
